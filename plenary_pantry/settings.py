"""
Django settings for plenary_pantry project.
...
ROOT_URLCONF = 'plenary_pantry.urls'
...
WSGI_APPLICATION = 'plenary_pantry.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': config('DB_NAME', default='plenary_pantry'),
